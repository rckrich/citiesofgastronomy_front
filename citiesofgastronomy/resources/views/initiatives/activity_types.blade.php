    ...
    <div class="row mx-0">
        ...
        <div class="col-12 px-0 text-right row mx-0 py-2">
            ...
            <div class="input-group">
                ...
                <input id="search_box" name="search_box" value="<?php if($sub=='actype'){echo $search_box;}?>" class="form-control me-2" type="search" placeholder="{{__('initiatives.filters.type.search_ph')}}" aria-label="{{__('initiatives.filters.type.search_ph')}}" aria-describedby="basic-addon1">
            </div>
            </form>
            </div>
        </div>
