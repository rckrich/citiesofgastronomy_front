            ...
            <div class="row mx-0">
                <form class="pb-5 my-3">
                    <div class="form-group py-2">
                        <label class="form-label" for="data_name">{{__('initiatives.edit.data_name')}}</label>
                        <input id="data_name" name="data_name" class="form-control" placeholder="{{__('initiatives.edit.ph_name')}}"/>
                    </div>
                    <div class="form-group py-2">
                        <label class="form-label" for="data_continent">{{__('initiatives.edit.data_continent')}}</label>
                        <select id="data_continent" name="data_continent" class="form-control" placeholder="">
                            <option>{{__('initiatives.edit.ph_continent')}}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group py-2">
                        <label class="form-label" for="data_cities">{{__('initiatives.edit.data_cities')}}</label>
                        <div class="row">
                            <div class="col-6">
                    ...
                    <div class="form-group py-2">
                        <label class="form-label" for="data_name">{{__('initiatives.edit.data_photo')}}</label>
                    ...
                    <div class="row mx-0 py-2">
                        <div class="col-12 px-0 my-2">
                            <p class="section-title"><b>{{__('initiatives.edit.section_about')}}</b></p>
                        </div>

                        <div class="row py-2">
                            <div class="col-12 px-0 my-2">
                                <p class="form-label"><b>{{__('initiatives.edit.data_acttype')}}</b></p>
                            </div>
                        ...
                        <div class="row py-2">
                            <div class="col-12 px-0 my-2">
                                <p class="form-label"><b>{{__('initiatives.edit.data_topics')}}</b></p>
                            </div>
                            <div class="row form-group py-2">
                                <div class="col-6">
                                    <input id="data_sample_acttype_1" class="" type="checkbox" aria-hidden="true" />
                        ...
                        <div class="row py-2">
                            <div class="col-12 px-0 my-2">
                                <p class="form-label"><b>{{__('initiatives.edit.data_connections')}}</b></p>
                            </div>
                            <div class="row form-group py-2">
                                <div class="col-6">
                        ...
                        <div class="row py-2">
                            <div class="col-12 px-0 my-2">
                                <p class="form-label"><b>{{__('initiatives.edit.data_sdg')}}</b></p>
                            </div>
                            <div class="row form-group py-2">
                                <div class="col-6">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header b-none px-4">
            <h5 class="modal-title" id="uploadLinkModalLabel">{{__('initiatives.edit.upload_link_title')}}</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>            
        <form class="">
        <div class="modal-body px-4">
            <div class="form-group py-2">
                <label class="form-label" for="data_link_name">{{__('initiatives.edit.data_link_name')}}</label>
                <input id="data_link_name" name="data_link_name" class="form-control" placeholder="{{__('initiatives.edit.ph_link_name')}}"/>
            </div>
            <div class="form-group py-2">
                <label class="form-label" for="data_link">{{__('initiatives.edit.data_link')}}</label>
                <input id="data_link" name="data_link" class="form-control" placeholder="{{__('initiatives.edit.ph_link')}}"/>
            </div>
        </div>
...
<div class="modal fade" id="uploadPDFModal" tabindex="-1" aria-labelledby="uploadPDFModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header b-none px-4">
            <h5 class="modal-title" id="uploadPDFModalLabel">{{__('initiatives.edit.upload_pdf_title')}}</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>            
        <form class="">
        <div class="modal-body px-4">
            <div class="form-group py-2">
                <label class="form-label" for="data_pdf_name">{{__('initiatives.edit.data_pdf_name')}}</label>
                <input id="data_pdf_name" name="data_pdf_name" class="form-control" placeholder="{{__('initiatives.edit.ph_pdf_name')}}"/>
            </div>
            <div class="py-2 row mx-0">
                <p class="form-label px-0" for="new_city_img">{{__('initiatives.edit.data_pdf')}}</p>
